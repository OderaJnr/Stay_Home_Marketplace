...
public class LocateRidersMapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_locate_riders_maps);
        ...
        PricelistBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(LocateRidersMapsActivity.this,BuyersViewItemsActivity.class);
        ...
        FindSellersAround.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {  requestbol=true;
                    ...
                    FindSellersAround.setText("Finding Delivery Riders around you");
            ...
            public void onDataChange(DataSnapshot dataSnapshot)
            {
                ...
                if (dataSnapshot.exists())
                {
                    ...
                    for(DataSnapshot datas: dataSnapshot.getChildren()){
                        ...
                        Toast.makeText(LocateRidersMapsActivity.this, displayname, Toast.LENGTH_SHORT).show();
                    ...
                    Toast.makeText(LocateRidersMapsActivity.this, "No sellers around at the moment", Toast.LENGTH_SHORT).show();
                }
            }
